...
class TestProgram(unittest.TestCase):
    def test_case_1(self):
        self.assertEqual(
            program.smallestDifference([-1, 5, 10, 20, 3], [26, 134, 135, 15, 17]),
            [20, 17],
        )
    ...
    def test_case_3(self):
        self.assertEqual(
            program.smallestDifference([10, 0, 20, 25], [1005, 1006, 1014, 1032, 1031]),
            [25, 1005],
        )
    ...
    def test_case_5(self):
        self.assertEqual(
            program.smallestDifference(
                [10, 0, 20, 25, 2000], [1005, 1006, 1014, 1032, 1031]
            ),
            [2000, 1032],
        )
